...
json_folder = r"C:\AZ_DEVOPS_PYTHON\Investment_Banking\ib-genai-project\data\json\AAPL\metrics_ratio_growth"

# Folder where Excel files will be created
excel_folder = r"C:\AZ_DEVOPS_PYTHON\Investment_Banking\ib-genai-project\data\excel\AAPL\metrics_ratio_growth"
