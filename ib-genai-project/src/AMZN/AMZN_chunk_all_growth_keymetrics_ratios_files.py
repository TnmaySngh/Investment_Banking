...
#
# The base input/output folders come from config.txt (same file used
# by json_to_excel_converter.py / excel_data_cleaner.py), so this
# script never needs code changes to point at a new machine. The
# company symbol (AMZN) is hardcoded above since this file is
# dedicated to AMZN - see the AAPL_*.py scripts for Apple's equivalent.
